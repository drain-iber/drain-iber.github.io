...
project = 'Drain Documentation'
copyright = '2025, Drain'
author = 'Drain Authors'
...
html_theme_options = {
    ...
    'canonical_url': 'https://drain-iber.github.io/latest/en/',
...
html_context = {
    # When a Drain version reaches end of life, set this to True to show an information
    # message on the top of the page.
    'outdated': False,
    # When a new Drain version is released, set this to False to remove the disclaimer
...
if html_context['isTesting'] or html_context['outdated']:
    html_css_files = ['css/drain_topbar.css']
...
docs_url = 'https://drain-iber.github.io/'


if version not in version_list:
    raise ValueError('Drain version is not in version list',
...
context = {
    ...
    'github_user': 'Drain',
    'github_repo': 'Drain-Documentation',
    'github_version': 'master/',
    'github_url': 'https://github.com/drain-iber/Drain-Documentation',
    'weblate_url': 'https://translations.docs.drain.org/',
}
