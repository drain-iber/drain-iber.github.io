...
Drain is the first free software designed for the 1D-2D simulation of sewerage networks in QGIS environment
...
To work with Drain we can create two types of schemes:

- Empty data: empty data schema in which we will import our data.
- Example data: schema that contains a project with example data to practice and become familiar with Drain.
